...
@Composable
fun IntroScreen_04(navController: NavHostController) {
    Image(
...
//        verticalArrangement = Arrangement.Center
        ...
        Image(
            painter = painterResource(id = R.drawable.introgenie),
            contentDescription = "image description",
            contentScale = ContentScale.Fit,
            modifier = Modifier
                .width(390.dp)
...
@Composable
fun IntroScreenPreview_04() {
    IntroScreen_04(navController = rememberNavController())
}