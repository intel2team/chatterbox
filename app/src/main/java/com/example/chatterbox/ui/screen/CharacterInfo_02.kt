...
@Composable
fun IntroScreen_02(navController: NavHostController) {
    Image(
        painter = painterResource(id = R.drawable.background_02),
...
//        verticalArrangement = Arrangement.Center
        ...
        Image(
            painter = painterResource(id = R.drawable.introolaf),
            contentDescription = "image description",
            contentScale = ContentScale.FillBounds,
            modifier = Modifier
                .width(470.dp)
...
@Composable
fun IntroScreenPreview_02() {
    IntroScreen_02(navController = rememberNavController())
}